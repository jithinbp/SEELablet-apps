...
#
# Created: Tue May  3 09:42:59 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.trigger_frame.setMinimumSize(QtCore.QSize(0, 75))
        self.trigger_frame.setMaximumSize(QtCore.QSize(16777215, 150))
        ...
        self.verticalLayout_5 = QtGui.QVBoxLayout(self.trigger_frame)
        ...
        self.verticalLayout_5.addWidget(self.triggerBox)
        ...
        self.verticalLayout_5.addWidget(self.dial_11)
        ...
        self.verticalLayout_5.addWidget(self.trigger_level_label)
        self.frame_7 = QtGui.QFrame(self.trigger_frame)
        ...
        self.trigger_select_box = QtGui.QComboBox(self.frame_7)
        ...
        self.trigger_select_box.addItem(_fromUtf8(""))
        self.trigger_select_box.addItem(_fromUtf8(""))
        self.horizontalLayout_3.addWidget(self.trigger_select_box)
        ...
        self.menuHigh_res_mode = QtGui.QMenu(self.menuOptions)
        self.menuHigh_res_mode.setObjectName(_fromUtf8("menuHigh_res_mode"))
        MainWindow.setMenuBar(self.menubar)
        self.actionEnable_12_bit = QtGui.QAction(MainWindow)
        self.actionEnable_12_bit.setObjectName(_fromUtf8("actionEnable_12_bit"))
        self.actionDisable_12_bit = QtGui.QAction(MainWindow)
        self.actionDisable_12_bit.setObjectName(_fromUtf8("actionDisable_12_bit"))
        self.menuHigh_res_mode.addAction(self.actionEnable_12_bit)
        self.menuHigh_res_mode.addAction(self.actionDisable_12_bit)
        self.menuOptions.addAction(self.menuHigh_res_mode.menuAction())
        ...
        QtCore.QObject.connect(self.actionEnable_12_bit, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.enable12)
        QtCore.QObject.connect(self.actionDisable_12_bit, QtCore.SIGNAL(_fromUtf8("triggered()")), MainWindow.disable12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.trigger_level_label.setText(_translate("MainWindow", "0 mV", None))
        ...
        self.menuHigh_res_mode.setTitle(_translate("MainWindow", "High res mode", None))
        self.actionEnable_12_bit.setText(_translate("MainWindow", "enable 12-bit", None))
        self.actionEnable_12_bit.setToolTip(_translate("MainWindow", "enable 12-bit acquisition. Only works in single channel mode", None))
        self.actionDisable_12_bit.setText(_translate("MainWindow", "disable 12-bit", None))
