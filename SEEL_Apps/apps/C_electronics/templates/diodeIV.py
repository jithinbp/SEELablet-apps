...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.startV, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.stopV, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.tracesBox, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.stepV, 3, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Voltage Range", None))
        self.label_6.setText(_translate("MainWindow", "Step Size (V)", None))
        self.label_3.setText(_translate("MainWindow", "(PV1 via 1K resistor)", None))
