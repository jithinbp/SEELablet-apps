...
""))
        ...
        self.optionBox_2 = QtGui.QComboBox(self.ImageFrame)
        self.optionBox_2.setObjectName(_fromUtf8("optionBox_2"))
        self.optionBox_2.addItem(_fromUtf8(""))
        self.optionBox_2.addItem(_fromUtf8(""))
        self.optionBox_2.addItem(_fromUtf8(""))
        self.optionBox_2.addItem(_fromUtf8(""))
        self.optionBox_2.addItem(_fromUtf8(""))
        ...
        self.optionBox_2.addItem(_fromUtf8(""))
        self.optionBox_2.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.optionBox_2, 3, 0, 1, 1)
        ...
        QtCore.QObject.connect(self.optionBox, QtCore.SIGNAL(_fromUtf8("currentIndexChanged(int)")), Form.setGainCH1)
        QtCore.QObject.connect(self.optionBox_2, QtCore.SIGNAL(_fromUtf8("currentIndexChanged(int)")), Form.setGainCH2)
    ...
    def retranslateUi(self, Form):
        ...
        self.optionBox_2.setItemText(0, _translate("Form", "+/-16V", None))
        self.optionBox_2.setItemText(1, _translate("Form", "+/-8V", None))
        self.optionBox_2.setItemText(2, _translate("Form", "+/-4V", None))
        self.optionBox_2.setItemText(3, _translate("Form", "+/-3V", None))
        self.optionBox_2.setItemText(4, _translate("Form", "+/-2V", None))
        self.optionBox_2.setItemText(5, _translate("Form", "+/-1.5V", None))
        self.optionBox_2.setItemText(6, _translate("Form", "+/-1V", None))
        self.optionBox_2.setItemText(7, _translate("Form", "+/-500mV", None))
        self.optionBox_2.setItemText(8, _translate("Form", "+/-160V", None))
