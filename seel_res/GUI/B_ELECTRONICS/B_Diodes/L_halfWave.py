...
from SEEL_Apps.templates import ui_template_graph
...
class AppWindow(QtGui.QMainWindow, template_graph.Ui_MainWindow,utilitiesClass):
	def __init__(self, parent=None,**kwargs):
		...
		a1={'TITLE':'TIMEBASE','MIN':0,'MAX':9,'FUNC':self.set_timebase,'TYPE':'dial','UNITS':'S','TOOLTIP':'Set Timebase of the oscilloscope'}
