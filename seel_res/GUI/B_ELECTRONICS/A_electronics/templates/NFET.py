...
#
# Created: Tue Jun 14 00:05:39 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.baseV.setMinimum(-3.3)
        self.baseV.setMaximum(3.3)
        self.baseV.setSingleStep(0.01)
        self.baseV.setProperty("value", -1.2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 794, 353))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Gate Voltage", None))
        ...
        self.label_8.setText(_translate("MainWindow", "Gate voltage(PV2) ", None))
        self.label_4.setText(_translate("MainWindow", "Initial Voltage (V)", None))
        self.label.setText(_translate("MainWindow", "Drain Voltage Range(PV1)", None))
