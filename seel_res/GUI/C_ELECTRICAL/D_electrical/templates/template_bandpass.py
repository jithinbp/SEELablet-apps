...
# Form implementation generated from reading ui file 'seel_res/GUI/C_ELECTRICAL/D_electrical/templates/template_bandpass.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.tracesBox, 4, 4, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 3, 2, 1, 1)
        self.progress = QtWidgets.QProgressBar(self.frame)
        self.progress.setProperty("value", 0)
        self.progress.setObjectName("progress")
        self.gridLayout.addWidget(self.progress, 3, 3, 1, 3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 791, 424))
