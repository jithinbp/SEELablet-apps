...
from templates import ui_flow_designer as designer
...
'hint':'''
	...
	make flows by dragging and dropping graphical code blocks for rapid prototyping.<br> severely in beta testing mode. <br>
	Also known as flow based programming.
	'''
}
